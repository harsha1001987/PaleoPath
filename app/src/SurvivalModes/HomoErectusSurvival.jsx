...
import homoErectus from "../assets/homo-erectus.png";
...
const scenarios = [
  {
    ...
    description:
      "Dawn breaks over the savanna. Your tribe needs food. A herd of antelope grazes nearby, but you also spot smoke rising from distant hills - another tribe's fire. What do you do?",
    decisions: [
      {
        id: "hunt",
        text: "Lead the hunt for antelope",
        consequence: "You organize your hunting party and pursue the herd.",
        healthChange: -10,
        energyChange: -20,
        wisdomChange: 10,
        nextStage: 2,
      ...
      {
        id: "fire",
        text: "Investigate the distant fire",
        consequence: "Curiosity drives you toward the unknown tribe.",
        healthChange: 0,
        energyChange: -15,
        wisdomChange: 20,
        nextStage: 3,
      ...
      {
        id: "gather",
        text: "Gather roots and berries instead",
        consequence: "A safer choice - you lead foraging near the camp.",
        healthChange: 5,
        energyChange: -5,
        wisdomChange: 5,
        nextStage: 2,
  ...
  },
  {
    ...
    description:
      "A saber-toothed cat stalks through the tall grass nearby! Your group freezes. You must act quickly to protect everyone.",
    decisions: [
      {
        id: "fire-scare",
        text: "Use fire to scare it away",
        consequence: "You grab a burning branch and advance, flames dancing!",
        healthChange: 0,
        energyChange: -10,
        wisdomChange: 25,
        nextStage: 4,
      ...
      {
        id: "hide",
        text: "Hide in the tall grass silently",
        consequence: "Everyone drops low and holds their breath...",
        healthChange: -5,
        energyChange: -5,
        wisdomChange: 10,
        nextStage: 4,
      ...
      {
        id: "group-defense",
        text: "Form a defensive circle with weapons",
        consequence: "Your tribe bands together, spears outward!",
        healthChange: -15,
        energyChange: -25,
        wisdomChange: 15,
        nextStage: 4,
  ...
  {
    id: 3,
    title: "The Strange Tribe",
    description:
      "You approach the other tribe's camp. They notice you and gather, watching cautiously. Their leader steps forward with an unknown gesture.",
    decisions: [
      {
        id: "peaceful",
        text: "Offer a peaceful greeting",
        consequence: "You raise open hands and bow your head slightly.",
        healthChange: 0,
        energyChange: -5,
        wisdomChange: 30,
        nextStage: 4,
      ...
      {
        id: "gift",
        text: "Present a gift of gathered food",
        consequence: "You offer berries and roots as a sign of goodwill.",
        healthChange: -5,
        energyChange: 0,
        wisdomChange: 25,
        nextStage: 4,
      ...
      {
        id: "retreat",
        text: "Back away slowly and return home",
        consequence: "Caution wins - you retreat to safety.",
        healthChange: 0,
        energyChange: -10,
        wisdomChange: 5,
        nextStage: 4,
  ...
  },
  {
    ...
    title: "Night Falls",
    description:
      "The day's challenges are behind you. Your tribe gathers around the fire as darkness envelops the savanna. Stars emerge above.",
    decisions: [
      {
        id: "teach",
        text: "Teach the young ones about fire",
        consequence: "You pass knowledge to the next generation.",
        healthChange: 10,
        energyChange: 10,
        wisdomChange: 20,
        nextStage: -1,
      ...
      {
        id: "plan",
        text: "Plan tomorrow's journey",
        consequence: "Strategic thinking secures the future.",
        healthChange: 5,
        energyChange: 5,
        wisdomChange: 25,
        nextStage: -1,
      ...
      {
        id: "rest",
        text: "Rest and recover strength",
        consequence: "Sleep heals the weary body.",
        healthChange: 20,
        energyChange: 25,
        wisdomChange: 5,
        nextStage: -1,
  ...
  const handleDecision = (decision) => {
    ...
    setTimeout(() => {
      ...
      if (decision.nextStage === -1) {
        let outcome = "";
        if (newWisdom >= 60) {
          outcome = "A true leader emerges! Your wisdom guides your tribe to prosperity.";
        } else if (newHealth >= 70) {
          outcome = "A strong survivor! Your resilience keeps your people alive.";
        } else {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-stone-950">
      <style>{`
        ...
        * {
        ...
        .bg-savanna {
          position: absolute;
          inset: 0;
          background-image: url(${savannaBg});
        ...
        .stat-card {
          background: linear-gradient(135deg, rgba(40, 30, 20, 0.9) 0%, rgba(30, 20, 15, 0.95) 100%);
        ...
        .stat-card:hover {
          border-color: rgba(220, 170, 100, 0.6);
          box-shadow: 
        ...
        .scenario-panel {
          background: linear-gradient(135deg, rgba(25, 18, 12, 0.95) 0%, rgba(35, 25, 18, 0.98) 100%);
          border: 3px solid rgba(180, 140, 90, 0.4);
          box-shadow: 
        ...
        .decision-button {
          background: linear-gradient(135deg, rgba(60, 45, 30, 0.6) 0%, rgba(40, 30, 20, 0.8) 100%);
        ...
        .decision-button::before {
          ...
          background: linear-gradient(135deg, 
            rgba(220, 170, 100, 0) 0%, 
            rgba(220, 170, 100, 0.1) 100%
          );
          opacity: 0;
        ...
        .decision-button:hover {
          ...
          box-shadow: 
            -4px 0 12px rgba(220, 170, 100, 0.3),
        ...
        .back-link:hover {
          color: rgba(245, 200, 130, 1);
          gap: 0.75rem;
        }
        
        .glow-text {
          text-shadow: 0 0 20px rgba(220, 170, 100, 0.5);
        }
      `}</style>
      ...
      <div className="prehistoric-container relative z-10 min-h-screen flex flex-col">
        ...
        {/* Main Game Area */}
        <div className="flex flex-col items-center justify-center w-full max-w-7xl mx-auto px-2 md:px-8">
          {/* Stats Row */}
...
export default HomoErectusSurvival;