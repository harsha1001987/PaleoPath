...
import homoHabilis from "../assets/realhomo-habilis.png";

const scenarios = [
  {
    id: 1,
    title: "Stone Tools Discovery",
    description:
      "Your group finds sharp stones by the river. Some suggest using them to cut meat or dig roots. Others worry about injury. What do you do?",
    decisions: [
      {
        id: "use-tools",
        text: "Experiment with stone tools",
        consequence: "You teach your group to use stones for cutting and digging.",
        healthChange: 0,
        energyChange: -10,
        wisdomChange: 15,
        nextStage: 2,
      ...
      {
        id: "avoid-risk",
        text: "Avoid using the stones",
        consequence: "You play it safe, but miss an opportunity.",
        healthChange: 5,
        energyChange: 0,
        wisdomChange: 0,
        nextStage: 2,
      ...
      {
        id: "observe",
        text: "Observe animals using stones",
        consequence: "You watch how animals use stones, learning from nature.",
        healthChange: 0,
        energyChange: -5,
        wisdomChange: 10,
        nextStage: 2,
  ...
  },
  {
    ...
    title: "Food Scarcity",
    description:
      "The dry season arrives. Food is scarce. You spot shellfish in muddy banks and birds nesting in trees. How will you feed your group?",
    decisions: [
      {
        id: "shellfish",
        text: "Harvest shellfish with tools",
        consequence: "You use stones to open shells, providing new food.",
        healthChange: 10,
        energyChange: -10,
        wisdomChange: 10,
        nextStage: 3,
      ...
      {
        id: "climb",
        text: "Climb trees for eggs",
        consequence: "Risky, but you get eggs. Some minor injuries occur.",
        healthChange: -10,
        energyChange: -15,
        wisdomChange: 5,
        nextStage: 3,
      ...
      {
        id: "forage",
        text: "Forage for roots and berries",
        consequence: "You find some food, but not enough for everyone.",
        healthChange: 0,
        energyChange: -5,
        wisdomChange: 5,
        nextStage: 3,
  ...
  },
  {
    ...
    description:
      "A leopard prowls near your camp. Your group is frightened. What is your strategy?",
    decisions: [
      {
        id: "group-hide",
        text: "Hide together in caves",
        consequence: "You lead everyone to safety in nearby caves.",
        healthChange: 5,
        energyChange: -10,
        wisdomChange: 10,
        nextStage: 4,
      ...
      {
        id: "throw-stones",
        text: "Throw stones to scare it",
        consequence: "You use stones to drive the predator away.",
        healthChange: 0,
        energyChange: -15,
        wisdomChange: 15,
        nextStage: 4,
      ...
      {
        id: "climb-trees",
        text: "Climb trees to escape",
        consequence: "Some escape, but a few are scratched by branches.",
        healthChange: -5,
        energyChange: -10,
        wisdomChange: 5,
        nextStage: 4,
  ...
  },
  {
    ...
    description:
      "The danger is gone. Night falls. You gather the group and share what you learned. How do you teach?",
    decisions: [
      {
        id: "story",
        text: "Tell stories about survival",
        consequence: "Your stories inspire and teach the young.",
        healthChange: 10,
        energyChange: 10,
        wisdomChange: 20,
        nextStage: -1,
      ...
      {
        id: "demonstrate",
        text: "Demonstrate tool use",
        consequence: "Hands-on teaching spreads practical skills.",
        healthChange: 5,
        energyChange: 5,
        wisdomChange: 25,
        nextStage: -1,
      },
      {
        ...
        consequence: "Everyone rests, ready for tomorrow.",
        healthChange: 20,
        energyChange: 25,
        wisdomChange: 5,
        nextStage: -1,
...
// Quiz questions for Homo habilis
const quizQuestions = [
  {
    question: "What is Homo habilis best known for?",
    options: ["First use of fire", "Making stone tools", "Artistic cave paintings", "Domestication of animals"],
    answer: "Making stone tools",
  },
  {
    question: "Where did Homo habilis live?",
    options: ["Europe", "Asia", "Africa", "Australia"],
    answer: "Africa",
  },
  {
    question: "What was a major adaptation of Homo habilis?",
    options: ["Bipedalism", "Language", "Tool making", "Agriculture"],
    answer: "Tool making",
  },
];

const HomoHabilisSurvival = () => {
  ...
  const handleDecision = (decision) => {
    ...
    setTimeout(() => {
      ...
      if (decision.nextStage === -1) {
        let outcome = "";
        if (newWisdom >= 60) {
          outcome = "A wise innovator! Your skills help your group thrive.";
        } else if (newHealth >= 70) {
          outcome = "A resilient survivor! Your leadership keeps your group safe.";
        } else {
    ...
    <div className="min-h-screen relative overflow-hidden bg-stone-950">
      <style>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .bg-savanna { position: absolute; inset: 0; background-image: url(${savannaBg}); background-size: cover; background-position: center; filter: brightness(0.7) contrast(1.1); }
        .bg-overlay { position: absolute; inset: 0; background: linear-gradient(to bottom, rgba(20, 15, 10, 0.85) 0%, rgba(35, 25, 15, 0.75) 50%, rgba(15, 10, 5, 0.95) 100%); }
...
export default HomoHabilisSurvival;
