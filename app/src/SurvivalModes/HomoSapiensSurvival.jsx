...
// No homo-sapiens image found, fallback to homo-habilis or generic image
import homoHabilis from "../assets/homo-habilis.png";
...
const scenarios = [
  {
    ...
    title: "A New Dawn",
    description:
      "You awake in a thriving Homo sapiens camp. The clan looks to you for leadership as the sun rises. You hear distant animal calls and see storm clouds gathering. What is your first move?",
    decisions: [
      {
        id: "hunt",
        text: "Lead a hunting party",
        consequence: "You organize a skilled group and set out for game.",
        healthChange: -5,
        energyChange: -15,
        wisdomChange: 10,
        nextStage: 2,
      ...
      {
        id: "shelter",
        text: "Reinforce shelters for the storm",
        consequence: "You direct the clan to strengthen shelters and gather supplies.",
        healthChange: 10,
        energyChange: -10,
        wisdomChange: 15,
        nextStage: 2,
      ...
      {
        id: "explore",
        text: "Scout the surrounding area",
        consequence: "You and a few others explore, mapping new resources.",
        healthChange: 0,
        energyChange: -10,
        wisdomChange: 20,
        nextStage: 2,
  ...
  },
  {
    ...
    description:
      "Dark clouds roll in. Lightning flashes. The clan is anxious. You must decide how to keep everyone safe and calm.",
    decisions: [
      {
        id: "fire",
        text: "Keep the fire burning bright",
        consequence: "You maintain a large fire, boosting morale and safety.",
        healthChange: 5,
        energyChange: -5,
        wisdomChange: 10,
        nextStage: 3,
      ...
      {
        id: "story",
        text: "Tell stories to distract the clan",
        consequence: "You share tales of ancestors, easing fears and teaching lessons.",
        healthChange: 0,
        energyChange: 0,
        wisdomChange: 25,
        nextStage: 3,
      ...
      {
        id: "guard",
        text: "Post guards for the night",
        consequence: "You assign sentries, ensuring everyone feels protected.",
        healthChange: 0,
        energyChange: -10,
        wisdomChange: 10,
        nextStage: 3,
  ...
  },
  {
    ...
    description:
      "At dawn, a group of strangers approaches. They carry gifts but also weapons. The clan looks to you for guidance.",
    decisions: [
      {
        id: "trade",
        text: "Welcome them and propose trade",
        consequence: "You offer goods and establish friendly relations.",
        healthChange: 0,
        energyChange: -5,
        wisdomChange: 20,
        nextStage: 4,
      ...
      {
        id: "defend",
        text: "Prepare for possible conflict",
        consequence: "You ready the clan for defense, just in case.",
        healthChange: -10,
        energyChange: -10,
        wisdomChange: 10,
        nextStage: 4,
      ...
      {
        id: "observe",
        text: "Observe quietly before acting",
        consequence: "You watch and learn, gathering information before engaging.",
        healthChange: 0,
        energyChange: 0,
        wisdomChange: 15,
        nextStage: 4,
  ...
  },
  {
    ...
    description:
      "The challenges of the day are over. The clan gathers to reflect and plan for the future. Your leadership has shaped their fate.",
    decisions: [
      {
        id: "teach",
        text: "Teach new skills to the young",
        consequence: "You pass on knowledge, ensuring the clan's survival.",
        healthChange: 10,
        energyChange: 10,
        wisdomChange: 20,
        nextStage: -1,
      ...
      {
        id: "celebrate",
        text: "Hold a celebration feast",
        consequence: "You bring the clan together in joy and unity.",
        healthChange: 15,
        energyChange: 5,
        wisdomChange: 10,
        nextStage: -1,
      },
      {
        ...
        consequence: "You ensure everyone is well-rested for the days ahead.",
        healthChange: 20,
        energyChange: 20,
        wisdomChange: 5,
        nextStage: -1,
  ...
  const handleDecision = (decision) => {
    ...
    setTimeout(() => {
      ...
      if (decision.nextStage === -1) {
        let outcome = "";
        if (newWisdom >= 60) {
          outcome = "Your wisdom ensures the clan's prosperity and legacy.";
        } else if (newHealth >= 70) {
          outcome = "Your strength and resilience keep the clan thriving.";
        } else {
          outcome = "You survived the day. The story of Homo sapiens continues...";
        }
...
export default HomoSapiensSurvival;
