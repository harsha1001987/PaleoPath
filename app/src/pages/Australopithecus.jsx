import "./Australopithecus.css";
import { useState, useEffect } from "react";
import { useNavigate } from "react-router-dom";

export default function Australopithecus() {
  ...
  // Scroll-reveal: add .visible when blocks enter viewport
  useEffect(() => {
        ...
        <div className="species-details">
          ...
          <div className="detail-wide quiz-cta">
            <div className="quiz-card">
              ...
              <button
                className="quiz-btn"
                onClick={() => navigate("/quiz/austrolopithecus")}
              >
